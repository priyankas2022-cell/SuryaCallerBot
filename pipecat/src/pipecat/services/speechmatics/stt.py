...
try:
    ...
    HAS_SPEECHMATICS = True
except ModuleNotFoundError as e:
    logger.warning(f"Speechmatics not installed: {e}")
    logger.warning("Speechmatics STT service will not be available")
    HAS_SPEECHMATICS = False
    # Create dummy classes to avoid NameError
    AdditionalVocabEntry = None
    AudioEncoding = None
    EndOfUtteranceMode = None
    OperatingPoint = None
    SpeakerFocusConfig = None
    SpeakerFocusMode = None
    SpeakerIdentifier = None
    SpeechSegmentConfig = None
    VoiceAgentClient = None
    VoiceAgentConfig = None
    VoiceAgentConfigPreset = None
