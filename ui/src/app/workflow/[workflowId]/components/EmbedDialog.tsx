...
export function EmbedDialog({
                                            ...
                                            <div className="space-y-3">
                                                <div className="rounded-lg bg-muted/50 p-4">
                                                    ...
                                                    <ul className="text-sm space-y-2 text-muted-foreground">
                                                        <li>• Add a div with id=&quot;suryacaller-inline-container&quot; where you want the widget</li>
                                                        <li>• The widget will render inside this container</li>
                                                        <li>• You have full control over the container&apos;s styling</li>
                                                        <li>• Call window.SuryaCallerWidget.start() to begin the call</li>
                                                        <li>• Call window.SuryaCallerWidget.end() to end the call</li>
                                                    </ul>
                                                </div>
                                                ...
                                                <div className="rounded-lg bg-blue-50 dark:bg-blue-950/20 p-4 border border-blue-200 dark:border-blue-800">
                                                    ...
                                                    <pre className="text-xs overflow-x-auto">
                                                        <code className="text-blue-800 dark:text-blue-200">{`export function SuryaCallerAgent() {
  const [isCallActive, setIsCallActive] = useState(false);

  useEffect(() => {
    // Widget will auto-initialize when script loads
    window.SuryaCallerWidget?.onCallStart(() => {
      setIsCallActive(true);
    });
    window.SuryaCallerWidget?.onCallEnd(() => {
  ...
  return (
    <div className="my-8">
      ...
      <div id="suryacaller-inline-container" className="min-h-[400px]">
        {/* Widget renders here */}
      </div>
      <button
        onClick={() => window.SuryaCallerWidget?.start()}
