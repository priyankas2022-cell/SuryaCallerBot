            ...
            <Card className="h-full">
              <CardHeader>
                ...
                <CardDescription>
                  {selectedProvider === "ari" ? (
                    <>
                      Connect SuryaCaller to your Asterisk PBX using the Asterisk REST Interface (ARI).
                      ARI provides a WebSocket-based event model for controlling calls via Stasis applications.
                    </>
                  ) : selectedProvider === "cloudonix" ? (
                    <>
                      Cloudonix is an AI Connectivity platform, enabling you to connect SuryaCaller to any SIP product or SIP Telephony Provider.<br/><br/>
                      <iframe
                        style={{ border: 0 }}
                        width="100%"
                        height="450"
                  ...
                  <div className="space-y-4 text-sm">
                    <div>
                      ...
                      <ol className="list-decimal list-inside space-y-1 text-muted-foreground">
                        ...
                        <li>Ensure the ARI HTTP endpoint is accessible from SuryaCaller</li>
                  ...
                  <div className="space-y-4 text-sm">
                    <div>
                      ...
                      <ol className="list-decimal list-inside space-y-1 text-muted-foreground">
                        ...
                        <li>Configure your Cloudoinx <i>API Token</i> and <i>Cloudonix Domain Name</i> in SuryaCaller</li>
                        <li>Configure an optional outbound phone number for your SuryaCaller agent</li>
                      </ol>
                    </div>
                    <div className="bg-muted border border-border rounded p-3">
                      <p className="text-sm">
                  ...
                  <div className="pt-4 space-y-3">
                    ...
                    <div className="text-center">
                      <p className="text-xs text-muted-foreground">
                        ...
                        <a
                          href="https://docs.suryacaller.com/integrations/telephony/inbound"
                          target="_blank"
                          rel="noopener noreferrer"
