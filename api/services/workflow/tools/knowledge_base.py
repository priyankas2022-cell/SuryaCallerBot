...
async def _perform_retrieval(
    ...
    try:
        ...
        if use_local_embeddings:
            ...
            logger.info("Using LocalEmbeddingService for retrieval (FREE)")
            ...
            logger.info(f"Using OpenAIEmbeddingService for retrieval with model: {embeddings_model or 'text-embedding-3-small'}")
