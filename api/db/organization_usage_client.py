    ...
    async def get_usage_history(
        ...
        async with self.async_session() as session:
            ...
            for run in runs:
                ...
                if call_duration == 0 and run.usage_info:
                    call_duration = run.usage_info.get("call_duration_seconds", 0)
                if dograh_tokens == 0 and run.usage_info:
                    dograh_tokens = run.usage_info.get("dograh_token_usage", 0)
